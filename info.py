...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [TELUGU MACHA™](https://t.me/+K7ss_DvjBBljNDll)</b>⚡\n\n🎦 <b>File Name: </b> ➥  {file_caption} \n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Telugumacha™](https://t.me/Telugumacha_updates)</b> ↭  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌IMDb Data by: @Telugumachabot \n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 \n\n♥️ we are nothing without you ♥️ \n\n💛 Please Share Us 💛\n\n⚠️Click on the button 👇 below to get your query privately")
...
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Chakri_05') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','Chakri_05')  # WITHOUT @ [  add only handle - don't add full url  ] 
...
URL = "https:/{lazyprincess-d0db71de9c98.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "http://lazyprincess-d0db71de9c98.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lazyprincess-d0db71de9c98.herokuapp.com/".format(FQDN)
else:
    URL = "http://lazyprincess-d0db71de9c98.herokuapp.com/".format(FQDN)
...
DOWNLOAD_TEXT_URL = "https://t.me/watch098/14"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Telugumacha_updates"
